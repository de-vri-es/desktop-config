...
myKeys conf@(XConfig {XMonad.modMask = modm}) = M.fromList $ [
		...
		((0, xF86XK_AudioRaiseVolume), spawn "volume-ctl output up 5"),
		((0, xF86XK_AudioLowerVolume), spawn "volume-ctl output down 5"),
		((0, xF86XK_AudioMute), spawn "volume-ctl output toggle-mute"),
		((shiftMask, xF86XK_AudioRaiseVolume), spawn "volume-ctl input up 5"),
		((shiftMask, xF86XK_AudioLowerVolume), spawn "volume-ctl input down 5"),
		((shiftMask, xF86XK_AudioMute), spawn "volume-ctl input toggle-mute"),
		((0, xF86XK_AudioMicMute), spawn "volume-ctl input toggle-mute"),
